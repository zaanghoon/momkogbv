...
6.짜오를 비유하자면 존나 밝은 촛불이라고 본다. 존나게 밝긴한데 초가 존나 빨리 타는 촛불? 짜장면이 분다고 보기보단 촛농이 녹아내리는 느낌이 더 강함""")
        ...
        if message.content.startswith("""!니나"""):
            await message.channel.send("""
니나 
548
1 오른손                   딜캐없음  22데미지 
...
기본 커맨드 콤보
3RP 6LKLK 236 RKRPLK   44데미지
3LK RK RK  중상하       54데미지
1LK 악마발                  17데미지
LP RK 동시에 아이보리    23데미지 
4LP RK 띄우는 아이보리  18뎀미지
오른잡 원투원  투원LK    42데미지
 236 양발 양발LKRK양잡  50데미지  ! 니나 왼발이 상대방 왼쪽다리 허리에 닿기전에 콤보넣어야함

9양발 발잡기                38데미지
9양발 발잡기  475 오른잡 68데미지
9양발 발잡기  74 오른잡 69    79데미지 천천히 콤보가능 ! 다리꺽기전에 콤보넣어야함

내가만든 콤보 
1. RKLKRP 6LKLK 236RKRPLK  75딜 //// 안전빵 
   RKLKRP 6LKLK 대시 5 6RK LKLK 75딜 /// ! 대시후에 빠르게 넣어야함 살짝 위험한 콤보""")
